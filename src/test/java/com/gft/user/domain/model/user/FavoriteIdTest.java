...
class FavoriteIdTest {
    ...
    @Test
    void should_throwIllegalArgumentException_when_favoriteIdIsNull() {
    ...
    @Test
    void should_throwIllegalArgumentException_when_favoriteIdIsNegative() {
        var exception = assertThrows(IllegalArgumentException.class, () -> new FavoriteId(-3487347L));
        assertEquals("Product ID is not valid", exception.getMessage());
    }

    @Test
    void should_createFavoriteId_when_favoriteIdIsPositive() {
