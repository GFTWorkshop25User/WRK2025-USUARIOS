...
class LoyaltyPointsTest {
    ...
    @Test
    void should_throwIllegalArgumentException_when_valueIsNegative() {
    ...
    @Test
    void should_createLoyaltyPoints_when_valueIsPositive() {
        var loyaltyPoints = new LoyaltyPoints(10);
        assertEquals(10, loyaltyPoints.getValue());
    }

    @Test
    void should_createLoyaltyPoints_when_valueIsZero() {
        var loyaltyPoints = new LoyaltyPoints(0);
        assertEquals(0, loyaltyPoints.getValue());
    }

    @Test
    void should_throwIllegalArgumentException_when_incrementNegativeQuantity() {
    ...
    @Test
    void should_incrementQuantity_when_incrementPositiveQuantity() {
        LoyaltyPoints loyaltyPoints = new LoyaltyPoints(10);
    ...
    @Test
    void should_throwIllegalArgumentException_when_decrementNegativeQuantity() {
        LoyaltyPoints loyaltyPoints = new LoyaltyPoints(10);
    ...
    @Test
    void should_throwIllegalArgumentException_when_remainingQuantityIsNegative() {
        LoyaltyPoints loyaltyPoints = new LoyaltyPoints(10);
    ...
    @Test
    void should_decrementQuantity_when_decrementPositiveQuantity() {
        LoyaltyPoints loyaltyPoints = new LoyaltyPoints(10);
