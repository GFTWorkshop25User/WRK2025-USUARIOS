...
public class GetFavoriteProductsUseCaseTest {
    ...
    void should_throwException_when_userIdDoesNotExist() {
        ...
        assertThrows(UserNotFoundException.class, () -> getFavoriteProductsUseCase.execute(userId));
    }
    ...
    void should_returnFavoriteIds_when_userIdIsValid() {
        ...
        assertEquals(getFavoriteProductsUseCase.execute(userId), user.getFavoriteProductIds());
    }
